"""Системные диалоги выбора папки (локальный запуск веб-сервера)."""
...
def _pick_via_tk(title: str) -> str | None:
    code = f"""
...
def pick_directory(
    title: str = "Выберите каталог проекта 1С",
    *,
